...
public class StudentServiceMockTest {
	...
	public void getAllStudentsByLessonId() {
		...
		when(studentRepository.findStudentsByLessonsId(Long.valueOf(10001))).thenReturn(List.copyOf(students));
		assertEquals(List.copyOf(students), studentService.getAllStudentsByLessonId(Long.valueOf(10001)));
	...
	public void getAllLessonsByStudentId() {
		...
		when(lessonRepository.findLessonsByStudentsId(Long.valueOf(10001))).thenReturn(List.copyOf(lessons));
		assertEquals(List.copyOf(lessons), studentService.getAllLessonsByStudentId(Long.valueOf(10001)));
